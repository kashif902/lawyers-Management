...
echo "<script type='text/javascript'> document.location = 'add-lawyer-advocate.php'; </script>";
} else {
...
<head>
  ...
  <title>LRMS  | Add Lawyer and Advocate</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Lawyer and Advocate</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
